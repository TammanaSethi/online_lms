  ...
  const resetPassword = async () => {
    ...
    try {
      if(newPassword !== conPassword){
        return toast.error("Pasword is not matched")
      }
  ...
  return (
    <div className='min-h-screen flex items-center justify-center bg-gray-100 px-4'>
      ...
      {step == 1 && <div className='bg-white shadow-md rounded-xl p-8 max-w-md w-full'>
        ...
        <h2 className='text-2xl font-bold mb-6 text-center text-gray-800'>Forget Your Pasword</h2>
      ...
      {step == 2 && <div className='bg-white shadow-md rounded-xl p-8 max-w-md w-full'>
        ...
        <form className='space-y-4' onSubmit={(e)=>e.preventDefault()}>
          <div>
            ...
            <label htmlFor='otp' className='block text-sm font-medium text-gray-700'>Please enter 4-digit code sent to your email.</label>
      ...
      {step == 3 && <div className='bg-white shadow-md rounded-xl p-8 max-w-md w-full'>
        ...
        <form className='space-y-4' onSubmit={(e)=>e.preventDefault()}>
          <div>
            ...
            <input id='conpassword' type="text" className='mt-1 w-full px-4 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-[black]' placeholder='********' required onChange={(e)=>setNewPassword(e.target.value)} value={newPassword}/>
          ...
          <div>
            ...
            <input id='password' type="text" className='mt-1 w-full px-4 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-[black]' placeholder='********' required onChange={(e)=>setConPassword(e.target.value)} value={conPassword}/>
