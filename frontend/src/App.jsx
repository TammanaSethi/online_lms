...
import CreateLecture from "../src/pages/Educator/CreateLecture"
...
import getPublishedCourses from "./customHooks/getPublishedCourses";
    ...
    <>
      ...
      <Routes>
        ...
        <Route path='/createlecture/:courseId' element={userData?.role === "educator" ? <CreateLecture/> : <Navigate to={"/signup"}/>}/>
         ...
         <Route path='/editlecture/:lectureId' element={userData?.role === "educator" ? <EditLecture/> : <Navigate to={"/signup"}/>}/>
